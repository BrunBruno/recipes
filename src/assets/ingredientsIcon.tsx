...
import { IngredientTypeData } from "../utils";
...
const IngredientIcon = ({ ingType, subType, color }: IngredientIconProps) => {
  switch (ingType) {
    ///////////////////////////
    case "met":
      if (subType === "pou") {
        return (
          <svg
            fill={color ? color : IngredientTypeData.met.color}
            viewBox="0 0 512 512"
          >
            <g>
              <g>
                <path d="M463.082,48.942c-65.224-65.224-170.777-65.223-235.998,0c-52.8,52.791-112.042,178.557-94.809,260.012l-31.589,31.58 C75.4,325.568,41.797,328.624,19.572,350.85c-26.089,26.078-26.102,68.316,0,94.407c8.312,8.317,18.676,14.195,30.04,17.161 c2.966,11.353,8.832,21.718,17.155,30.035c26.036,26.036,68.375,26.026,94.402,0c21.947-21.951,25.38-55.517,10.311-81.103 l31.598-31.602c81.443,17.214,207.201-42.001,260.005-94.806C528.309,219.715,528.304,114.164,463.082,48.942z M137.571,398.056 c-6.518,6.513-6.518,17.079,0,23.598c13.004,13.015,13.004,34.186,0,47.201c-13.004,13.004-34.18,13.027-47.207,0 c-7.323-7.328-9.235-15.927-9.539-21.849c-0.445-8.534-7.257-15.357-15.797-15.802c-5.921-0.309-14.526-2.216-21.859-9.544 c-13.03-13.041-13.067-34.129,0-47.207c12.603-12.603,34.593-12.603,47.195,0c6.528,6.528,17.096,6.502,23.598,0l31.802-31.794 c3.049,4.685,6.516,9.079,10.517,13.08c4.002,4.003,8.397,7.472,13.086,10.523L137.571,398.056z M238.881,296.741 c-6.517,6.517-17.083,6.517-23.6,0c-6.517-6.517-6.517-17.083,0-23.6c6.517-6.517,17.083-6.517,23.6,0 C245.397,279.659,245.397,290.225,238.881,296.741z M286.081,155.14c-6.517,6.517-17.083,6.517-23.6,0 c-6.517-6.517-6.517-17.083,0-23.6s17.084-6.517,23.6,0C292.598,138.058,292.598,148.623,286.081,155.14z M380.482,249.541 c-6.517,6.517-17.083,6.517-23.6,0c-6.517-6.517-6.517-17.083,0-23.6c6.517-6.517,17.084-6.517,23.6,0 C386.999,232.459,386.999,243.024,380.482,249.541z M404.082,131.54c-6.517,6.517-17.083,6.517-23.6,0s-6.517-17.083,0-23.6 s17.083-6.517,23.6,0S410.599,125.023,404.082,131.54z" />
              </g>
            </g>
          </svg>
        );
        ...
        return (
          ...
          >
            <path
              id="secondary"
              d="M17.47,13A6.5,6.5,0,1,0,6.53,13Z"
              fill={color ? color : IngredientTypeData.met.color}
              strokeWidth={2}
            ></path>
            <path
              id="primary"
              d="M17.47,13A6.5,6.5,0,1,0,6.53,13ZM9,17h6m4,4H5a1,1,0,0,1-1-1V14a1,1,0,0,1,1-1H19a1,1,0,0,1,1,1v6A1,1,0,0,1,19,21Z"
              fill="none"
              stroke={color ? color : IngredientTypeData.met.color}
              strokeLinecap="round"
        ...
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <g>
              <path
                fill={color ? color : IngredientTypeData.met.color}
                d="M415.381,393.634c-59.076-1.08-81.879-60.082-81.879-60.082c23.035-0.072,19.606-25.194,19.606-25.194
      ...
      return (
        ...
        >
          <g>
            <path
              fill={color ? color : IngredientTypeData.dir.color}
              d="M360.273,137.058c-11.117-25.722-17.455-65.426-19.045-83.196c13.676-1.363,24.376-12.763,24.376-26.794 C365.604,12.11,353.494,0,338.543,0H173.456c-14.951,0-27.061,12.11-27.061,27.068c0,14.031,10.708,25.431,24.376,26.794 c-1.576,17.77-7.928,57.475-19.038,83.196c-20.651,47.775-25.572,92.81-25.572,115.076c0,22.258,0,211.768,0,211.768 c0,26.565,21.533,48.098,48.106,48.098H337.74c26.557,0,48.098-21.534,48.098-48.098c0,0,0-189.51,0-211.768 C385.838,229.868,380.926,184.833,360.273,137.058z"
            />
          </g>
        </svg>
      );
    ...
    case "fat":
      if (subType === "but") {
        return (
          <svg
            fill={color ? color : IngredientTypeData.fat.color}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 60 60"
          >
            <path
              d="M59.967,16.577c-0.003-0.012-0.01-0.022-0.014-0.034c-0.022-0.072-0.049-0.142-0.086-0.207
	...
	c0.041-0.015,0.084-0.026,0.123-0.047l39-20.441C59.794,33.272,60,32.931,60,32.559V16.831C60,16.744,59.989,16.659,59.967,16.577z
	 M2,29.209l17,7.873v14.365L2,43.712V29.209z M21,51.347V37.16l37-18.703v13.497L21,51.347z"
        ...
        //       <path
        //         fill={color ? color : IngredientTypeData.fat.color}
        //         d="M19,33a3.416,3.416,0,0,0-3.3141,2.9835l-1.3718,13.033A2.65,2.65,0,0,0,17,52H55a2.65,2.65,0,0,0,2.6859-2.9835l-1.3718-13.033A3.416,3.416,0,0,0,53,33Z"
        //       />
        //       <polyline
        //         fill="#ffffff"
        //         points="12.251 52 60.189 52 58 56 13.616 56 12.251 52"
        //       />
        //     </g>
        //     <g id="line">
        //       <path
        //         fill="none"
        //         stroke={color ? color : IngredientTypeData.fat.color}
        ...
        //         stroke-linejoin="round"
        //         stroke-width="2"
        //         d="M36,56H15a2.4394,2.4394,0,0,1-1.82-.5833l-.2389-.2381L9.0074,47.17,4.88,47.1514"
        //       />
        //       <polyline
        //         fill="none"
        //         stroke={color ? color : IngredientTypeData.fat.color}
        ...
        //         stroke-linejoin="round"
        //         stroke-width="2"
        //         d="M36,56H57a2.4394,2.4394,0,0,0,1.82-.5833l.2389-.2381,3.934-8.0083,4.1271-.0189"
        //       />
        //     </g>
        //   </svg>
        // );
      ...
      if (subType === "oni") {
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <g>
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M355.256,107.302c-3.288-4.589-8.799-11.583-15.341-19.682c-6.558-8.115-14.187-17.408-21.948-26.948
		...
		C398.04,195.011,381.414,143.75,355.256,107.302z"
              ...
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M201.982,439.116c3.526,2.076,7.143,3.839,10.784,5.512c-5.297-10.397-9.968-22.426-14.064-36.193
		...
		C169.794,414.705,185.192,429.222,201.982,439.116z"
              ...
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M88.668,251.892c0.024-62.302,18.034-118.935,47.85-160.59c3.955-5.512,9.598-12.646,16.264-20.902
		...
		C106.694,370.825,88.692,314.184,88.668,251.892z"
              ...
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M270.702,442.832c6.386-9.062,12.943-23.712,18.43-42.314c11.064-37.256,18.183-90.19,18.158-148.626
		...
		c2.554,1.73,4.317,2.175,5.94,2.2c1.622-0.024,3.386-0.469,5.94-2.2C264.448,450.453,267.53,447.372,270.702,442.832z"
              ...
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M417.796,109.411c-7.588-6.822-22.434-18.645-39.134-31.851c-12.498-9.886-26.092-20.63-38.87-31.011
		...
		c41.12-36.959,65.976-87.198,65.992-142.464C483.78,196.609,458.924,146.386,417.796,109.411z"
              ...
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M222.596,453.139c-2.62-3.856-7.868-4.853-11.724-2.233l-42.586,28.968c-3.856,2.62-4.852,7.868-2.233,11.724
		c2.62,3.847,7.868,4.853,11.724,2.232l42.586-28.968C224.211,462.242,225.216,456.986,222.596,453.139z"
              />
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M243.234,456.664c-4.417-1.482-9.204,0.898-10.686,5.314l-13.059,38.896
		...
		C250.031,462.934,247.65,458.148,243.234,456.664z"
              ...
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M301.119,450.906c-3.855-2.62-9.104-1.623-11.724,2.233c-2.62,3.847-1.622,9.104,2.233,11.723l42.586,28.968
		c3.856,2.62,9.104,1.615,11.724-2.232c2.62-3.856,1.623-9.104-2.233-11.724L301.119,450.906z"
              />
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M279.444,461.978c-1.483-4.416-6.27-6.796-10.686-5.314c-4.416,1.483-6.796,6.27-5.314,10.686l13.058,38.896
        ...
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <g>
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M115.343,123.839c0.814,1.256,3.343,2.605,7.23,4.014c7.586-1.069,14.943-1.586,21.885-1.586
		...
		l-3.098-0.746L290.531,107.181z"
              ...
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M485.83,198.564c-38.169-57.253-117.544-70.584-160.338-52.195c-18.27-5.906-43.872-12.27-69.49-12.27
        ...
        return (
          ...
          >
            <g>
              <g>
                <path
                  d="M350.755,246.298L311.331,25.489c-0.045-0.252-0.101-0.463-0.157-0.634l-41.888,25.421
            ...
            <g>
              <g>
                <path
                  d="M265.369,266.302l-131.046-100.96l-33.671,20.436c0.125,0.127,0.285,0.273,0.488,0.429l211.518,162.958l1.154-3.041
			L265.369,266.302z"
                />
              </g>
            </g>
            <g>
              <g>
                <path
                  d="M171.975,112.404L78.879,40.935c-2.674-2.062-7.318-2.199-9.386-0.941L27.605,65.412c0.126,0.129,0.287,0.274,0.491,0.432
            ...
            <g>
              <g>
                <path
                  d="M476.569,430.273c-3.406-5.619-7.762-10.512-12.946-14.546c-0.088-0.069-0.172-0.138-0.256-0.21
            ...
            <g>
              <g>
                <path
                  d="M185.841,1.513c-0.899-1.481-2.837-1.958-4.321-1.056l-41.983,25.479c-1.481,0.899-1.954,2.837-1.056,4.317
        ...
        return (
          ...
          >
            <g>
              <g>
                <path
                  d="M342.349,156.254c-19.226-8.673-38.348-13.605-53.676-16.394c-0.001,0-0.002,0-0.003-0.001L321.787,9.525l-30.381-7.72
        ...
        return (
          <svg
            fill={color ? color : IngredientTypeData.veg.color}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 57.862 57.862"
          >
            <g>
              <path
                d="M12.913,32.816c-0.4,0.167-0.823,0.341-1.281,0.529c-3.854,1.578-9.13,3.74-10.8,6.229
		...
		s1.023-0.391,1.414,0l1,1C17.109,53.179,17.109,53.812,16.719,54.202z"
              />
              <path
                d="M55.197,12.383l-1.369-2.29l-2.455-2.455l0,0L25.12,33.891c-0.195,0.195-0.451,0.293-0.707,0.293s-0.512-0.098-0.707-0.293
        ...
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <g>
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M474.089,265.702c-35.243-47.443-102.935-50.784-178.786-13.105c-75.852,37.664-94.267,107.57-129.097,156.498
		...
		C510.991,246.001,359.693,325.107,325.934,347.531z"
              ...
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M323.323,191.732c16.51-18.47,86.694-96.323,93.322-92.886c6.319,3.27-63.493,88.385-95.466,120.906
        ...
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <g>
              <path
                fill={color ? color : IngredientTypeData.veg.color}
                d="M473.351,143.524c-25.16-42.424-61.794-75.883-108.887-96.065c-31.417-13.442-67.549-20.975-108.249-20.975 c-39.99,0-75.811,7.798-107.174,21.513C117.679,61.722,90.74,81.402,68.68,105.395C24.568,153.355-0.008,218.733,0,287.559 c0,7.004,0.256,14.025,0.767,21.084l0.036,0.492v0.492c0.009,11.272,2.444,21.595,6.784,30.934 c4.341,9.321,10.606,17.638,18.303,24.614c15.394,13.953,36.533,22.352,58.338,22.325c10.788-0.01,20.537-2.161,29.219-6.019 c8.673-3.858,16.287-9.411,22.662-16.352c12.722-13.889,20.437-33.414,20.446-55.502c-0.01-13.122-5.28-24.878-13.871-33.487 c-8.618-8.59-20.373-13.87-33.496-13.87v-27.332c20.583-0.009,39.342,8.381,52.821,21.869 c13.497,13.478,21.886,32.237,21.877,52.82c0,68.424,0,165.967,0,165.967c0.009,2.782,1.086,5.171,2.91,7.013 c1.833,1.824,4.232,2.9,7.012,2.909H318.61c2.782-0.009,5.18-1.085,7.023-2.909c1.814-1.842,2.899-4.231,2.908-7.013 c0,0,0-97.543,0-165.967c-0.009-20.583,8.38-39.342,21.878-52.811c13.469-13.497,32.228-21.887,52.81-21.878v27.332 c-13.122,0-24.878,5.28-33.486,13.87c-8.59,8.609-13.872,20.364-13.872,33.487c0,16.571,4.342,31.7,11.883,44.076 c7.551,12.384,18.221,22.005,31.216,27.778c8.682,3.858,18.43,6.009,29.219,6.019c16.352,0.009,32.338-4.687,45.798-12.95 c13.47-8.263,24.349-20.018,30.842-33.989c4.332-9.338,6.776-19.661,6.786-30.934v-0.31l0.018-0.31 c0.237-5.353,0.365-10.669,0.365-15.95C512,237.373,498.475,185.93,473.351,143.524z"
              />
            </g>
          </svg>
        );
        ...
        return (
          <svg
            fill={color ? color : IngredientTypeData.veg.color}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 445.822 445.822"
          >
            <g>
              <path
                d="M423.655,146.208c-16.213-12.432-40.302-20.336-68.47-30.969c-18.909,29.224-59.251,39.051-92.711,20.521
		...
		C448.088,176.968,441.044,159.539,423.655,146.208z"
              />
              <path
                d="M277.008,109.516c17.64,9.769,37.905,6.297,49.292-5.847c-11.617-5.011-23.711-10.757-36.186-17.662
		...
		C251.56,80.725,259.366,99.746,277.008,109.516z"
              />
              <path
                d="M234.987,263.723c-12.59,1.244-25.954,2.077-40.213,2.08c-0.023,0-0.045-0.003-0.068-0.003
		...
		S230.781,280.305,234.987,263.723z"
              />
              <path
                d="M326.777,252.818c-17.349,0-37.44,3.609-60.912,7.032c-2.444,35.052-33.416,62.868-71.159,62.868
      ...
      return (
        ...
        >
          <path
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M16,23c-1.7,0-3.3-0.4-4.7-1.1l0.7,2.2V29c0,0.6,0.4,1,1,1h6c0.6,0,1-0.4,1-1v-4.8l0.7-2.2C19.3,22.6,17.7,23,16,23z"
          />
          <path
            fill={color ? color : IngredientTypeData.veg.color}
            stroke="none"
        ...
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
            <path
              ...
              d="M29.6,13.7L29,13.1c-1-1-2.1-1.7-3.3-2.3l1.3-4.5c0.1-0.3,0-0.7-0.3-1s-0.6-0.4-1-0.3l-4.5,1.3C20.7,5.2,20,4.1,19,3.1
	...
	C25.6,13.5,24.9,13.7,24.3,13.9z"
        ...
        return (
          ...
          >
            <g>
              <path
                d="M14.068,18.064c0.442,0.282,1.026,0.175,1.339-0.246C16.269,16.663,17.579,16,19,16c1.461,0,2.837,0.717,3.682,1.919
		c0.375,0.532,1.262,0.532,1.637,0C25.163,16.717,26.539,16,28,16c1.61,0,3.107,0.873,3.909,2.277
		c0.179,0.314,0.512,0.504,0.868,0.504c0.034,0,0.067-0.001,0.101-0.005c0.393-0.04,0.726-0.307,0.85-0.683
		C34.336,16.244,36.053,15,38,15c1.522,0,2.929,0.764,3.764,2.044c0.15,0.231,0.39,0.389,0.661,0.438
		c0.272,0.047,0.551-0.018,0.772-0.181c2.598-1.928,4.365-4.279,5.253-6.99c0.171-0.521-0.109-1.082-0.628-1.258
		c-2.598-0.884-4.988-1.332-7.102-1.332c-2.607,0-4.374,0.681-5.488,1.359c-1.106-5.75-4.852-8.067-6.342-8.776
		C28.707,0.121,28.463,0,28.187,0h-0.211c-0.276,0-0.52,0.12-0.703,0.305c-1.49,0.708-5.237,3.024-6.343,8.776
		c-1.114-0.679-2.881-1.359-5.487-1.359c-2.114,0-4.504,0.448-7.102,1.332c-0.519,0.176-0.799,0.737-0.628,1.258
		C8.714,13.373,10.913,16.054,14.068,18.064z"
              />
              <path
                d="M51.5,28.5c0-2.246-1.142-4.296-3.018-5.484c-0.153-2.075-1.295-3.899-2.999-4.982c-0.349,0.299-0.713,0.591-1.094,0.873
		c-0.523,0.387-1.141,0.59-1.789,0.59c-0.172,0-0.346-0.015-0.518-0.045c-0.822-0.147-1.544-0.627-1.994-1.317
		C39.625,17.425,38.844,17,38,17c-1.081,0-2.035,0.691-2.373,1.719c-0.37,1.125-1.371,1.929-2.549,2.047
		c-0.1,0.01-0.199,0.015-0.301,0.015c-1.074,0-2.072-0.58-2.605-1.513C29.725,18.486,28.893,18,28,18
		c-0.811,0-1.575,0.399-2.045,1.069c-0.552,0.783-1.469,1.249-2.455,1.249s-1.903-0.466-2.453-1.247C20.575,18.399,19.811,18,19,18
		c-0.795,0-1.501,0.36-1.989,1.014c-0.901,1.212-2.737,1.552-4.018,0.737c-0.686-0.437-1.318-0.911-1.922-1.404
		C9.501,19.54,8.5,21.408,8.5,23.5c0,0.406,0.039,0.812,0.115,1.211C7.28,25.936,6.5,27.681,6.5,29.5
		c0,1.746,0.713,3.416,1.945,4.629C7.831,35.14,7.5,36.307,7.5,37.5c0,2.794,1.741,5.197,4.283,6.107
		C11.596,44.22,11.5,44.859,11.5,45.5c0,2.791,1.768,5.235,4.365,6.135C16.765,54.232,19.209,56,22,56
		c0.972,0,1.917-0.214,2.783-0.626C25.998,57.015,27.917,58,30,58c1.942,0,3.749-0.856,4.978-2.326C35.631,55.891,36.308,56,37,56
		c3.073,0,5.724-2.204,6.354-5.146c2.942-0.631,5.146-3.281,5.146-6.354c0-0.478-0.054-0.954-0.161-1.422
		c1.945-1.163,3.161-3.267,3.161-5.578c0-1.689-0.663-3.3-1.815-4.5C50.837,31.8,51.5,30.189,51.5,28.5z M26.504,29.201
		c0.548-0.047,1.035,0.361,1.082,0.911c0.152,1.774,1.547,2.574,2.696,2.72c1.142,0.149,2.686-0.277,3.276-1.952
		c0.183-0.521,0.756-0.795,1.275-0.61c0.521,0.184,0.794,0.754,0.61,1.275c-0.823,2.336-2.872,3.313-4.745,3.313
		c-0.227,0-0.45-0.014-0.669-0.042c-2.036-0.26-4.197-1.762-4.435-4.534C25.546,29.733,25.954,29.249,26.504,29.201z M13.764,29.584
		c-0.374-0.406-0.348-1.039,0.059-1.413c0.406-0.375,1.039-0.348,1.413,0.059c1.206,1.309,2.798,1.088,3.796,0.502
		c0.992-0.584,1.954-1.864,1.396-3.548c-0.174-0.524,0.111-1.09,0.635-1.263c0.525-0.174,1.09,0.111,1.263,0.635
		c0.872,2.635-0.517,4.862-2.281,5.9c-0.776,0.457-1.718,0.739-2.689,0.739C16.114,31.195,14.822,30.733,13.764,29.584z
		 M21.698,44.196c-0.227,0-0.45-0.014-0.669-0.042c-2.037-0.259-4.198-1.762-4.436-4.534c-0.047-0.55,0.36-1.035,0.911-1.082
		c0.549-0.048,1.035,0.36,1.082,0.911c0.152,1.774,1.547,2.574,2.696,2.721c1.142,0.144,2.686-0.279,3.276-1.952
		c0.183-0.521,0.756-0.794,1.275-0.61c0.521,0.184,0.794,0.754,0.61,1.275C25.62,43.219,23.571,44.196,21.698,44.196z
		 M31.982,51.729c-0.74,0.397-1.618,0.638-2.521,0.638c-1.303,0-2.657-0.5-3.722-1.751c-0.358-0.42-0.308-1.052,0.113-1.41
		c0.419-0.359,1.052-0.308,1.41,0.113c1.155,1.355,2.755,1.195,3.774,0.648c1.014-0.545,2.024-1.787,1.532-3.492
		c-0.153-0.531,0.153-1.085,0.684-1.238c0.531-0.151,1.085,0.152,1.238,0.684C35.259,48.588,33.785,50.759,31.982,51.729z
		 M40.954,42.784c-0.776,0.457-1.718,0.739-2.689,0.739c-1.243,0-2.535-0.461-3.593-1.61c-0.374-0.406-0.348-1.039,0.059-1.413
		c0.407-0.374,1.039-0.347,1.413,0.059c1.206,1.309,2.799,1.089,3.796,0.502c0.992-0.584,1.954-1.864,1.396-3.548
		c-0.174-0.524,0.111-1.09,0.635-1.263c0.524-0.174,1.09,0.111,1.263,0.635C44.106,39.519,42.717,41.746,40.954,42.784z
		 M45.24,27.564c-1.058,1.163-2.357,1.63-3.606,1.63c-0.958,0-1.886-0.274-2.653-0.72c-1.776-1.03-3.184-3.254-2.326-5.9
		c0.169-0.525,0.736-0.813,1.259-0.643c0.525,0.17,0.813,0.734,0.643,1.259c-0.549,1.694,0.426,2.973,1.427,3.554
		c0.996,0.578,2.583,0.789,3.777-0.526c0.372-0.407,1.003-0.438,1.413-0.067C45.582,26.523,45.611,27.155,45.24,27.564z"
              />
            </g>
          </svg>
        );
        ...
        return (
          <svg
            fill={color ? color : IngredientTypeData.frt.color}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 495.655 495.655"
          >
            <path
              d="M440.807,285.285c-35.938-66.251-104.355-117.192-163.703-99.753
	c-83.013-123.535-22.441-148.321-25.894-170.39c-6.313-39.897-121.214-3.551-130.364,140.131
	c-53.432,12.965-94.254,81.879-94.254,165.2c0,92.533,50.325,167.562,112.4,167.562c33.593,0,63.661-22.086,84.252-56.921
	c-54.356-82.64-60.896-182.828-14.468-241.859c-14.441-17.095-31.753-28.927-50.696-33.773c1.667-20.72,8.95-70.021,39.417-98.911
	c-6.694,49.736,19.468,106.24,47.39,147.841c-38.556,37.787-40.64,116.232-1.685,188.046
	c44.109,81.345,124.132,123.317,178.689,93.702C476.457,456.562,484.917,366.621,440.807,285.285z"
            />
          </svg>
        );
      } else if (subType === "alm") {
        ...
        return (
          ...
          >
            <g>
              <g>
                <path
                  d="M411.9,71.488l11.249-31.43L311.234,0l-22.917,83.591H88.851L120.244,512h238.479l31.393-428.409h-67.185l10.972-40.021
        ...
        return (
          ...
          >
            <path
              d="M19.61,4.39A4.86,4.86,0,0,0,16.06,3a5.2,5.2,0,0,0-3.55,1.56,17,17,0,0,0-2.44,3.15,7.19,7.19,0,0,1-2.36,2.36,17,17,0,0,0-3.15,2.44A5.2,5.2,0,0,0,3,16.06,4.75,4.75,0,0,0,7.79,21a5.22,5.22,0,0,0,3.7-1.56,17,17,0,0,0,2.44-3.15,7.19,7.19,0,0,1,2.36-2.36,17,17,0,0,0,3.15-2.44A5.2,5.2,0,0,0,21,7.94,4.77,4.77,0,0,0,19.61,4.39Z"
              fill={color ? color : IngredientTypeData.frt.color}
            ></path>
          </svg>
        );
    ...
    case "grn":
      if (subType === "brd") {
        return (
          <svg
            fill={color ? color : IngredientTypeData.grn.color}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 57.001 57.001"
          >
            <path
              d="M56.784,15.512C55.662,8.545,50.201,3.188,43.194,2.18c-1.45-0.207-2.938-0.214-4.411-0.028
        ...
        return (
          ...
          >
            <path
              ...
              fill={color ? color : IngredientTypeData.grn.color}
              stroke={color ? color : IngredientTypeData.grn.color}
              strokeWidth="0.96"
            />
          </svg>
        );
    ...
    case "spc":
      if (subType === "sau") {
        return (
          <svg
            fill={color ? color : IngredientTypeData.spc.color}
            version="1.2"
            baseProfile="tiny"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 256 256"
        ...
        return (
          ...
          >
            <path
              ...
              stroke={color ? color : IngredientTypeData.spc.color}
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
      ...
      return (
        ...
        >
          <g>
            <g>
              <path d="M356.174,200.348v-33.391c18.413,0,33.391-14.978,33.391-33.391C389.565,59.918,329.652,0,256,0 	S122.435,59.918,122.435,133.565c0,18.413,14.978,33.391,33.391,33.391v33.391c-27.619,0-50.087,22.468-50.087,50.087v211.478 	c0,27.619,22.468,50.087,50.087,50.087h200.348c27.619,0,50.087-22.468,50.087-50.087V250.435 	C406.261,222.816,383.793,200.348,356.174,200.348z M256,50.087c9.22,0,16.696,7.475,16.696,16.696 	c0,9.22-7.475,16.696-16.696,16.696s-16.696-7.475-16.696-16.696C239.304,57.562,246.78,50.087,256,50.087z M205.913,83.478 	c9.22,0,16.696,7.475,16.696,16.696c0,9.22-7.475,16.696-16.696,16.696c-9.22,0-16.696-7.475-16.696-16.696 	C189.217,90.953,196.693,83.478,205.913,83.478z M222.609,428.522c0,9.223-7.479,16.696-16.696,16.696 	c-9.217,0-16.696-7.473-16.696-16.696V283.826c0-9.223,7.479-16.696,16.696-16.696c9.217,0,16.696,7.473,16.696,16.696V428.522z 	 M322.783,428.522c0,9.223-7.479,16.696-16.696,16.696c-9.217,0-16.696-7.473-16.696-16.696V283.826 	c0-9.223,7.479-16.696,16.696-16.696c9.217,0,16.696,7.473,16.696,16.696V428.522z M322.783,200.348H189.217v-33.391h133.565 	V200.348z M306.087,116.87c-9.22,0-16.696-7.475-16.696-16.696c0-9.22,7.475-16.696,16.696-16.696s16.696,7.475,16.696,16.696 	C322.783,109.394,315.307,116.87,306.087,116.87z" />
            </g>
          </g>
        </svg>
      );
        ...
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <g>
              <path
                fill={color ? color : IngredientTypeData.oth.color}
                d="M135.277,110.802h44.08c0,0-3.42-31.918-35.338-75.233c-9.283-12.594-42.167-46.725-66.108-31.91
		c-12.536,7.762-10.881,31.494,3.418,41.027C108.691,62.929,132.623,89.141,135.277,110.802"
              />
              <path
                fill={color ? color : IngredientTypeData.oth.color}
                d="M395.769,191.077c0.516-7.802,4.409-12.611,9.183-15.564c8.469-5.24,12.728-3.003,12.728-3.003
        ...
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <g>
              <path
                fill={color ? color : IngredientTypeData.oth.color}
                d="M187.406,0h-59.448c-17.068,0-30.894,13.827-30.894,30.886v74.229h90.342V0z"
              />
              <rect
                x="209.243"
                fill={color ? color : IngredientTypeData.oth.color}
              ...
              <path
                fill={color ? color : IngredientTypeData.oth.color}
                d="M411.772,30.886C411.772,13.827,397.936,0,380.877,0H321.43v105.115h90.342V30.886z"
              />
              <path
                fill={color ? color : IngredientTypeData.oth.color}
