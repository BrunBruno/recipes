  ...
  ingredients: [
    {
      ...
      items: [
        ...
        { ingredient: iMET.ground_pork, amount: 500 },
        { ingredient: iMET.ground_beef, alt: true },
        { ingredient: iJAR.tomato_passata, amount: 400 },
        { ingredient: iJAR.canned_tomatoes, alt: true },
        { ingredient: iVEG.onion, amount: 1, unit: "szt" },
        { ingredient: iVEG.garlic, amount: 2, unit: "zbk" },
        { ingredient: iFAT.olive, amount: 1, unit: "lz" },
        { ingredient: iFAT.oil, amount: 1, alt: true },
